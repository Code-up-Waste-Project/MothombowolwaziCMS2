    ...
    var docDefinition = {
      ...
      content: [
       {canvas: [ { type: 'rect', x: 0, y: 0, w: 600, h: 200, color: '#000' },
        ...
        { text: 'Mthombowolwazi', style: 'header', color: "#fff", bold: true, alignment: "center", margin: [ 5, 2, 10, 20 ],	absolutePosition: { x: -100, y: 50 } },
        { text: 'General Service (PTY) LTD', fontSize: 10, color: "#fff", alignment: "center", margin: [ 5, 2, 10, 20 ], absolutePosition: { x: -100, y: 100 } },
        {
          ...
          fit: [100, 100], alignment: "right", margin:[ 5, -50 , 20, 80 ], absolutePosition: { x: -30, y: 50 }, width: 20
        },
        {
          layout: 'noBorders',
        ...
        { text: '', style: 'subheader'},
        {
          ...
          table: {
            widths: ['50%','50%'],
            body: [
              [{ text: 'Printed Time', color: 'gray', fontSize: 9 }, { text: this.timez, color: 'gray', Border: false, fontSize: 9 }],
